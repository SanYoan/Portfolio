          ...
          <div className="row">
            ...
            <div className="col-study-4">
              <div className="single-horizontal-timeline">
                ...
                <div className="timeline">
                  <div className="timeline-content">
                    <h4 className="title">CFA Saint-Paul, Rouen</h4>
                    <h5>Normandie, France</h5>
                    <p className="description">
                      Perfectionnement des techniques de boucherie avec un focus
                      sur la gestion d'équipes, la géstion des stocks, la
                      traçabilité des produits, et le respect des normes
                      strictes en matière d'hygiène. Projets professionnels axés
                      sur l’optimisation des processus en boucherie et
